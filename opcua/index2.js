...
module.exports = {
 ...
 createOPCUAClient: async function (io) {
    ...
    const itemToMonitor4 = {
      nodeId: config.geschMitnehmerfoerderer,
      attributeId: AttributeIds.Value,
    };
